...
<head>
    ...
    <title>SarStore - Top Up Mobile Legend</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                @if (session('user')->isAdmin == 1)
                    <a class="navbar-brand" href="{{ route('dashboard.admin') }}">SarStore</a>
                @endif
                @if (session('user')->isAdmin == 0)
                    <a class="navbar-brand" href="{{ route('dashboard.user') }}">SarStore</a>
                @endif
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    @if (session('user')->isAdmin == 1)
                        <li class="active">
                            <a href="{{ route('dashboard.admin') }}"> <i
                                    class="menu-icon fa fa-dashboard"></i>Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('product.index') }}"><i
                                    class="menu-icon fa fa-puzzle-piece"></i>Product</a>
                        </li>
                        <li>
                            <a href="{{ route('history') }}"><i class="menu-icon fa fa-thumbs-o-up"></i>Cek Transaksi</a>
                        </li>
                    @endif
                    @if (session('user')->isAdmin == 0)
                        <li class="active">
                            <a href="{{ route('dashboard.user') }}"> <i class="menu-icon fa fa-dashboard"></i>Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('cart.index') }}"><i class="menu-icon fa fa-puzzle-piece"></i>Carts</a>
                        </li>
                        <li>
                            <a href=""><i class="menu-icon fa fa-thumbs-o-up"></i>Cek Transaksi</a>
                        </li>
                    @endif
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div id="right-panel" class="right-panel bg-dark">
        ...
        <!-- Header-->
        <header id="header" class="header bg-dark text-light">
